    ...
    <>
      <style>{`
        @media (max-width: 768px) {
          ...
          .card-equipo .equipo-content {
            width: 100% !important;
          }
          .card-equipo .equipo-icon {
            margin-bottom: 16px !important;
          }
          .card-equipo .equipo-btn {
            width: 100% !important;
        ...
        <div style={{ maxWidth: 1200, width: '100%' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <Link href="/auth/login" className="btn-mobile" style={{
            ...
            {/* 3. Equipo (Practicantes, SENATI, etc.) - RESPONSIVE */}
            <div className="card-equipo" style={{
              ...
              <div className="equipo-icon" style={{ fontSize: 64, flexShrink: 0 }}>👨‍🔬</div>
              <div className="equipo-content" style={{ flex: 1, minWidth: 0 }}>
                <div style={{
              ...
              <Link href="/auth/login" className="equipo-btn" style={{
